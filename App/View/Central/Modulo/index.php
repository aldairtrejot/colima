                ...
                <div class="col-12">
                    ...
                    <nav>
                        <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#is_nav_asistencias"
...
<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-programas"
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="is_nav_asistencias" role="tabpanel"
                            aria-labelledby="nav-contact-tab">
                            <div class="div-spacing"></div>
                            <h5 class="card-title tittle-card-index">Control y asistencia</h5>
                            <?php include 'AsistenciasM/index.php' ?>
                        </div>
